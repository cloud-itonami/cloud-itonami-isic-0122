# Operator Quickstart — Orchard Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0122** (`cloud-itonami-isic-0122`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0122.git
cd cloud-itonami-isic-0122
```
...
- Blueprint governor key: `orchard-operations-governor`
- Likely source path: `orchardops.governor.cljc`
