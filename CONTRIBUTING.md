...
**Maturity: `:implemented`** — `src/orchardops/` implements the reference
OrchardOpsAdvisor / OrchardOperationsGovernor actor as a synchronous stub
...
fruit-species/varietal reference-data expansion in `orchardops.facts`. Open
